...
const AllContractors = () => {
  ...
  const [confirmDialog, setConfirmDialog] = useState({ open: false, id: null, isBlocked: false });
  ...
  return (
    <Box sx={{ p: 4 }}>
              ...
              <Card sx={{ boxShadow: 3, borderRadius: 2 }}>
                <CardContent>
                  ...
                  <Button
                    ...
                    onClick={() => handleConfirm(contractor._id, contractor.isBlocked)}
                    sx={{ width: "100%", mt: 2 }}
                  >
      ...
      <Dialog open={confirmDialog.open} onClose={handleClose}>
        <DialogTitle>Confirm {confirmDialog.isBlocked ? "unblock" : "block"} </DialogTitle>
        <DialogContent>
          <DialogContentText>
